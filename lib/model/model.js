...
export class Model {
  ...
  #insertIntoDocument() {
    ...
    referenceElement.insertAdjacentElement(position, this.#rootElement);
  }
  ...
  #drawAgentPath(agent) {
    this.#drawingCanvas.strokeStyle = agent.penColor;
    this.#drawingCanvas.lineWidth = 2;

    for (const { from, to } of agent.penStrokes) {
